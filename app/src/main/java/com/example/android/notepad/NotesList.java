...
public class NotesList extends ListActivity {
    ...
    public static final int FONT_BLUE=4;
    public static final int FONT_YELLOW=5;
    public static final int FONT_RED=6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl1 = (RelativeLayout) findViewById(R.id.background1);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.btn_stopmusic:
            ...
            Toast.makeText(this,"音乐停止播放", Toast.LENGTH_SHORT).show();
            break;
